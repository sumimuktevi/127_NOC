...
# SRAM macros — 18 instances (2 per tile, 9 tiles)
# define_pdn_grid \
#     -macro \
#     -name sram_macros \
#     -starts_with POWER \
...
# add_pdn_connect \
#     -grid sram_macros \
#     -laydefine_pdn_griders "$::env(PDN_VERTICAL_LAYER) Metal3"
...
# # Connect SRAM VDD/VSS to global power nets
# add_global_connection -net VDD -pin_pattern VDD -inst_pattern {.*sram.*}
# add_global_connection -net VSS -pin_pattern VSS -inst_pattern {.*sram.*}
