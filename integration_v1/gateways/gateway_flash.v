// GATEWAY for Flash → NoC Path
// This module receives packets from the Flash controller (via Wishbone bus)
// and injects them into the NoC mesh.
module gateway_flash (
    input wire clk,          // Global System Clock
    input wire rst,          // System Reset
    
    // Wishbone Slave Interface (Connects to topmod/housekeeping FSM)
