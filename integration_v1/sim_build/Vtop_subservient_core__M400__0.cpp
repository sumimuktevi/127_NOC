...
void Vtop_subservient_core__M400___nba_comb__TOP__system_top__DOT__noc_mesh__DOT__rows__BRA__0__KET____DOT__cols__BRA__1__KET____DOT__tile_inst__DOT__core_inst__15(Vtop_subservient_core__M400* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtop_subservient_core__M400___nba_comb__TOP__system_top__DOT__noc_mesh__DOT__rows__BRA__0__KET____DOT__cols__BRA__1__KET____DOT__tile_inst__DOT__core_inst__15\n"); );
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.i_wb_ack = vlSymsp->TOP.system_top__DOT__noc_mesh__DOT__rows__BRA__0__KET____DOT__cols__BRA__1__KET____DOT__tile_inst__DOT__wb_ack;
...
void Vtop_subservient_core__M400___nba_comb__TOP__system_top__DOT__noc_mesh__DOT__rows__BRA__0__KET____DOT__cols__BRA__1__KET____DOT__tile_inst__DOT__core_inst__19(Vtop_subservient_core__M400* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtop_subservient_core__M400___nba_comb__TOP__system_top__DOT__noc_mesh__DOT__rows__BRA__0__KET____DOT__cols__BRA__1__KET____DOT__tile_inst__DOT__core_inst__19\n"); );
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.servile__DOT__cpu__DOT__immdec__DOT__o_imm 
...
void Vtop_subservient_core__M400___act_comb__TOP__system_top__DOT__noc_mesh__DOT__rows__BRA__0__KET____DOT__cols__BRA__2__KET____DOT__tile_inst__DOT__core_inst__0(Vtop_subservient_core__M400* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtop_subservient_core__M400___act_comb__TOP__system_top__DOT__noc_mesh__DOT__rows__BRA__0__KET____DOT__cols__BRA__2__KET____DOT__tile_inst__DOT__core_inst__0\n"); );
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.i_sram_rdata = vlSymsp->TOP.system_top__DOT__noc_mesh__DOT__rows__BRA__0__KET____DOT__cols__BRA__2__KET____DOT__tile_inst__DOT__sram_rdata;
