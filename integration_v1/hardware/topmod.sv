module topmod (
    ...
    // Note: wbs_ack is declared as an input above, but the original
    // design drove it from this register. Verilator treats assignments to
    // inputs as errors. For simulation we simply comment out the drive.
