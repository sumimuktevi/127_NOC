...
VL_ATTR_COLD void Vtop_subservient_core___eval_initial__TOP__mesh_2x2__DOT__t00__DOT__core(Vtop_subservient_core* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_subservient_core___eval_initial__TOP__mesh_2x2__DOT__t00__DOT__core\n"); );
...
VL_ATTR_COLD void Vtop_subservient_core___stl_sequent__TOP__mesh_2x2__DOT__t00__DOT__core__1(Vtop_subservient_core* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_subservient_core___stl_sequent__TOP__mesh_2x2__DOT__t00__DOT__core__1\n"); );
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vtop_subservient_core___stl_sequent__TOP__mesh_2x2__DOT__t01__DOT__core__1(Vtop_subservient_core* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_subservient_core___stl_sequent__TOP__mesh_2x2__DOT__t01__DOT__core__1\n"); );
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vtop_subservient_core___stl_sequent__TOP__mesh_2x2__DOT__t10__DOT__core__1(Vtop_subservient_core* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_subservient_core___stl_sequent__TOP__mesh_2x2__DOT__t10__DOT__core__1\n"); );
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vtop_subservient_core___stl_sequent__TOP__mesh_2x2__DOT__t11__DOT__core__1(Vtop_subservient_core* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_subservient_core___stl_sequent__TOP__mesh_2x2__DOT__t11__DOT__core__1\n"); );
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vtop_subservient_core___ctor_var_reset(Vtop_subservient_core* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_subservient_core___ctor_var_reset\n"); );
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    vlSelf->o_sram_waddr = VL_SCOPED_RAND_RESET_I(9, __VscopeHash, 16092764788527308670ull);
    ...
    vlSelf->o_sram_raddr = VL_SCOPED_RAND_RESET_I(9, __VscopeHash, 2227053395370760471ull);
    ...
    vlSelf->rf_mem_if__DOT__o_sram_waddr = VL_SCOPED_RAND_RESET_I(9, __VscopeHash, 13595516172139932807ull);
    ...
    vlSelf->rf_mem_if__DOT__o_sram_raddr = VL_SCOPED_RAND_RESET_I(9, __VscopeHash, 11060537054903053042ull);
    ...
    vlSelf->rf_mem_if__DOT__i_wb_adr = VL_SCOPED_RAND_RESET_I(7, __VscopeHash, 1667952493454728824ull);
    ...
    vlSelf->rf_mem_if__DOT__rf_waddr = VL_SCOPED_RAND_RESET_I(9, __VscopeHash, 4054225803365403126ull);
    vlSelf->rf_mem_if__DOT__rf_raddr = VL_SCOPED_RAND_RESET_I(9, __VscopeHash, 16420943872970088220ull);
    ...
    vlSelf->rf_mem_if__DOT____VdfgRegularize_h04f68ef0_0_0 = 0;
    ...
    vlSelf->servile__DOT__cpu__DOT__state__DOT____VdfgRegularize_h53222178_0_2 = 0;
