...
#endif
            VL_FATAL_MT("mesh_3x3.v", 35, "", "Input combinational region did not converge after 100 tries");
        }
...
#endif
            VL_FATAL_MT("mesh_3x3.v", 35, "", "NBA region did not converge after 100 tries");
        }
...
#endif
                VL_FATAL_MT("mesh_3x3.v", 35, "", "Active region did not converge after 100 tries");
            }
...
void Vtop___024root___eval_debug_assertions(Vtop___024root* vlSelf) {
    ...
    if (VL_UNLIKELY(((vlSelfRef.wbs_stb_i & 0xfeU)))) {
        Verilated::overWidthError("wbs_stb_i");
    }
    if (VL_UNLIKELY(((vlSelfRef.wbs_we_i & 0xfeU)))) {
