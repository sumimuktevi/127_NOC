...
VL_ATTR_COLD void Vtop_gf180mcu_fd_ip_sram___05Fsram2048x8m8wm1___ctor_var_reset(Vtop_gf180mcu_fd_ip_sram___05Fsram2048x8m8wm1* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_gf180mcu_fd_ip_sram___05Fsram2048x8m8wm1___ctor_var_reset\n"); );
    ...
    vlSelf->A = VL_SCOPED_RAND_RESET_I(11, __VscopeHash, 3969090544990846983ull);
    ...
    vlSelf->marked_a = VL_SCOPED_RAND_RESET_I(11, __VscopeHash, 7874548100196941472ull);
    ...
    vlSelf->VSS__out = 0;
    vlSelf->VSS__en = 0;
    vlSelf->__VdfgRegularize_h41ac00f2_0_0 = 0;
