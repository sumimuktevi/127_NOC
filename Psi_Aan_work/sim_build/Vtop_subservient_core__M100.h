...
#ifndef VERILATED_VTOP_SUBSERVIENT_CORE__M100_H_
#define VERILATED_VTOP_SUBSERVIENT_CORE__M100_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtop_subservient_core__M100 final {
  public:
    ...
    struct {
        ...
        VL_OUT8(o_sram_waddr,7,0);
        VL_OUT8(o_sram_wdata,7,0);
        VL_OUT8(o_sram_wen,0,0);
        VL_OUT8(o_sram_raddr,7,0);
        ...
        CData/*7:0*/ rf_mem_if__DOT__rf_waddr;
        CData/*7:0*/ rf_mem_if__DOT__rf_raddr;
        CData/*0:0*/ rf_mem_if__DOT__regzero;
        CData/*7:0*/ rf_mem_if__DOT____VdfgRegularize_h18019837_0_0;
    ...
    // CONSTRUCTORS
    Vtop_subservient_core__M100() = default;
    ~Vtop_subservient_core__M100() = default;
    void ctor(Vtop__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtop_subservient_core__M100);
